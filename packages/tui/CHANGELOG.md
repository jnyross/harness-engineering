...
- Overlay numeric sizing now ignores non-finite width/max-height values (`NaN`/`Infinity`) and falls back to default sizing behavior instead of propagating invalid numeric state into overlay layout calculations.
