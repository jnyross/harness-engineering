...
- RPC mode now finalizes pending extension UI requests and exits when stdin closes, preventing orphaned headless processes when RPC input streams terminate unexpectedly.
