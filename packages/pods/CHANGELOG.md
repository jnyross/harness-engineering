...
- SCP setup-script copy now surfaces explicit parse/startup/signal/unknown-status diagnostics instead of a generic copy-failed message during `pods setup`.
