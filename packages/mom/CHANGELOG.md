...
- One-shot event scheduling now validates timestamp parsing and chunks delays above Node.js timer limits, preventing malformed/oversized schedules from executing immediately via runtime timer clamping.
