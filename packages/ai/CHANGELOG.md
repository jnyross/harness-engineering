...
- OpenAI Codex OAuth login now waits for lazy Node runtime imports before generating state/callback servers, eliminating startup race failures when login is invoked immediately after module load.
